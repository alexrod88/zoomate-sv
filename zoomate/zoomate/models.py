...
class Animal(models.Model):
    ...
    father = models.OneToOneField('self', null=True, on_delete=models.CASCADE, related_name="animal_father")
    mother  = models.OneToOneField('self', null=True, on_delete=models.CASCADE, related_name="animal_mother")
    lon = models.DecimalField(max_digits=9, decimal_places=6)
    lat = models.DecimalField(max_digits=9, decimal_places=6)
...
class Match(models.Model):
    animal_a = models.OneToOneField(Animal, on_delete=models.CASCADE, primary_key=True, related_name="animal_a")
    animal_b = models.OneToOneField(Animal, on_delete=models.CASCADE, related_name="animal_b")
